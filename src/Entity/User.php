...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserAppRelation::class, mappedBy: 'user', orphanRemoval: true)]
    ...
    public function removeUserAppRelation(UserAppRelation $userAppRelation): static
    {
        if ($this->userAppRelations->removeElement($userAppRelation)) {
            ...
            if ($userAppRelation->getUser() === $this) {
                $userAppRelation->setUser(null);
            }
        }
